...
This library implements the reactive runtime for [d3.express](https://d3.express) documents. It lets you publish your live documents wherever you want: on your website, integrated into your application or interactive dashboard, etc.
